        ...
        <View style={{justifyContent: 'center', alignContent: 'center'}}>
          <ScrollView showsVerticalScrollIndicator={false}>
            <View style={styles.footer2}>
              ...
              <Text style={styles.title}>Poin Saya: 100000 </Text>
              <View style={styles.footer2}>
                <Text style={{marginTop: 10, fontWeight: 'bold', fontSize: 15}}>
                  Voucher yang dapat ditukar{' '}
                </Text>
                <View style={{flexDirection: 'row', marginTop: 40}}>
                  ...
                  <TouchableOpacity
                    ...
                    <Text style={{textAlign: 'center'}}>
                      Potongan Belanja Senilai Rp. 20.000
                    </Text>
                ...
                <View style={styles.footer2}>
                  <View style={{flexDirection: 'row', marginTop: 15}}>
                    <TouchableOpacity
                      ...
                      <Text style={{textAlign: 'center'}}>
                        Potongan Belanja Senilai Rp. 30.000
                      </Text>
                    ...
                    <TouchableOpacity
                      ...
                      <Text style={{textAlign: 'center'}}>
                        Potongan Belanja Senilai Rp. 40.000
                      </Text>
